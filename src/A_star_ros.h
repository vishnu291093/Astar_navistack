...
class AstarROS : public nav_core::BaseGlobalPlanner {
public:

  AstarROS (ros::NodeHandle &); //this constructor is may be not needed
  AstarROS ();
  AstarROS(std::string name, costmap_2d::Costmap2DROS* costmap_ros);
